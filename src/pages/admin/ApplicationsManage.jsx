...
function ApplicationsManage() {
  ...
  return (
    <div>
      ...
      <h3 className="text-navy fw-bold mb-2">
        Manage Applications
      </h3>
      ...
      {loading ? (
        ...
        /* Applications table */
        <div
          className="glass-card bg-white p-0 overflow-hidden"
          style={{ overflowX: "auto" }}
        >
          <table
            className="table table-row-hover mb-0"
        ...
        <>
          ...
          >
            ...
            <div className="d-flex justify-content-between align-items-start mb-4">
              <h5 className="text-navy fw-bold mb-0">
                Application Details
              </h5>
            ...
            <dl className="small">
              ...
              <dd>
                {selectedApp.statement_of_purpose ? (
              ...
              <dd>
                <select
                  className={`form-select form-select-sm status-pill ${statusPillClass(
                    selectedApp.status
                  )}`}
                  style={{
                    border: "none",
            ...
            {selectedApp.statement_of_purpose && (
              <a
                ...
                className="btn btn-navy w-100 mb-2"
              >
                View Statement of Purpose
              </a>
            )}
            ...
            {/* View CV / Transcript */}
            {selectedApp.cv_transcript && (
              <a
                href={selectedApp.cv_transcript}
                target="_blank"
                rel="noopener noreferrer"
                className="btn btn-navy w-100 mb-2"
              >
